$(function() {
  ...
  // App configuration 99731b89-3b9a-42f8-addd-c54768248043
  //var authEndpoint = 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize?'; 
 //var authEndpoint = 'https://login.microsoftonline.com/99731b89-3b9a-42f8-addd-c54768248043/oauth2/v2.0/authorize?'; 


 // var authEndpoint = 'https://login.microsoftonline.com/investmichigan.org/oauth2/v2.0/authorize?'; 

  //var authEndpoint = 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize?'; 

  
  //nancy@investmichigan.org
  //var authEndpoint = 'https://login.microsoftonline.com/{99731b89-3b9a-42f8-addd-c54768248043}/oauth2/v2.0/authorize?'; 
 //var appId = '609b1820-f15d-4907-8305-af916d1437f4'; 



  var authEndpoint = 'https://login.microsoftonline.com/b224102b-27ea-42b5-90b6-173dd069e2a0/oauth2/v2.0/authorize?'; 
  var appId = 'f6898168-0620-4f9e-be49-6402fda3350a';
